...
interface MailsProps {
  /** A seal has finished breaking. Nothing listens yet — the letters lead nowhere. */
 ...
 */
export default function Mails({ onOpenLetter }: MailsProps) {
  ...
  const {
    ...
    follow,
    deckHandlers,
  } = useLetterDeck({ letters: LETTERS, stageRef, live, onOpenLetter });
