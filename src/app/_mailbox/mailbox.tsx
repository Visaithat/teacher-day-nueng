...
const GIFT_SETTLE_MS = TIMING.giftDelay + TIMING.gift;
...
export function Mailbox({ onOpenPresent }: MailboxProps) {
      ...
      style={
        {
          ...
          "--seat-ms": `${TIMING.seat}ms`,
          "--turn-ms": `${TIMING.turn}ms`,
          "--door-ms": `${TIMING.door}ms`,
          "--door-delay": `${TIMING.doorDelay}ms`,
          "--gift-ms": `${TIMING.gift}ms`,
          "--gift-delay": `${TIMING.giftDelay}ms`,
