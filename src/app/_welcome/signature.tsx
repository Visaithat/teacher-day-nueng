...
import { SIGNATURE_LINES, SIGNATURE_STROKE_WIDTH } from "./signature-data";

/** Timing of each line, in the custom properties the stylesheet reads. */
const LINE_TIMING: CSSProperties[] = [
  { "--sign-delay": "0.4s", "--sign-duration": "1.8s" } as CSSProperties,
  // Picks up the instant the first line lands, so the hand never stops.
  { "--sign-delay": "2.2s", "--sign-duration": "2.5s" } as CSSProperties,
];
